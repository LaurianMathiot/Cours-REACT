    ...
    <div className="main-header">
      ...
      <nav>
        <ul>
          ...
          <li>
            <Link className="link" to="/cocktails/randomcocktail">
              Cocktail aléatoire
            </Link>
          </li>
          <li>
            <form action="" className="header-form" onSubmit={handleSubmit}>
              <input type="text" name="search" className="btn" />
